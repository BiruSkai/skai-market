...
const Register = () => {
        ...
        return ( 
                <div className="container-md py-1 col-lg-7 d-flex align-items-center justify-content-center">
                        <div className="card col-md-6 shadow">
                                <div className="card-body">
                                <div className="h3 loginTitle">Register to Skai-market</div>
                                <form onSubmit={handleSubmit(onRegister)}>
                                        ...
                                        <div className="form-floating mb-3 loginText">
                                        ...
                                        <div class="form-floating mb-3 loginText">
                                        ...
                                        <div class="my-3">
                                                <button class="p-2 btn btn-primary col-12 loginText">Register</button>
                                        </div>
                                </form>                
